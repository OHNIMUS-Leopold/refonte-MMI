        ...
        <ul id="cards">
            ...
            <li class="card" id="card2">
                <div class="card-body">
                    ...
                    <div class="bg-[#D9D9D9] w-full aspect-square flex items-center"><img class="object-cover m-auto" src="https://placehold.co/150x300" alt="Logo création numérique" /></div>
                </div>
            </li>
